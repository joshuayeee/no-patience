...
function updateFormSteps() {
  ...
  stepCounter.textContent = `Step ${currentStep + 1} out of ${formSteps.length}`;
...
async function loadLocations() {
  ...
  setSelectPlaceholder(locationSelect, "Loading states...");
  ...
  try {
    ...
    if (response.ok && result.data) {
      ...
      if (us && Array.isArray(us.states)) {
        setSelectPlaceholder(locationSelect, "Select your state");
        us.states
          .map((s) => s.name)
        ...
        setSelectPlaceholder(locationSelect, "Failed to load locations");
      }
    } else {
      setSelectPlaceholder(locationSelect, "Failed to load locations");
    }
    ...
    setSelectPlaceholder(locationSelect, "Error loading locations");
  }
}
